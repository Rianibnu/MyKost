...
import { MapPin, ChevronLeft, Info, Calendar } from 'lucide-react';
...
export default function Show({ kost }: { kost: any }) {
    ...
    return (
        <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
            ...
            {/* Top Bar */}
            <div className="sticky top-0 z-40 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-md border-b border-neutral-200 dark:border-neutral-800 p-4">
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    ...
                    <span className="font-semibold">{kost.name}</span>
                </div>
            </div>
                                        ...
                                        <CardContent className="p-6">
                                            <div className="flex flex-col md:flex-row gap-6 justify-between items-start md:items-center">
                                                ...
                                                <form onSubmit={(e) => handleBooking(e, room.id)} className="w-full md:w-auto bg-white dark:bg-neutral-950 p-4 rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm">
                                                    ...
                                                    <Button type="submit" disabled={processing || room.stock < 1} className="w-full">
